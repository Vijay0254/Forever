...
const Error_404 = () => {
  return (
    <section className='flex auth-bg gap-y-1 md:gap-y-4 h-screen justify-center items-center flex-col'>
        <div className='bg-white flex justify-center gap-3 flex-col items-center xl:p-20 p-4 md:p-20 rounded'>
            ...
            <h3 className='text-4xl md:text-6xl font-bold font-playfair text-slate-500'>Page Not Found</h3>
